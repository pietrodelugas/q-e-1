...
MODULE qes_init_module
  ...
  !
  !
  SUBROUTINE qes_init_output(obj, tagname, convergence_info, algorithmic_info, atomic_species,&
                            atomic_structure, basis_set, dft, magnetization, total_energy, band_structure,&
  ...
  !
  !
  SUBROUTINE qes_init_vdW(obj, tagname, vdw_corr, non_local_term, london_s6, ts_vdw_econv_thr,&
                         ts_vdw_isolated, london_rcut, xdm_a1, xdm_a2, london_c6)
    !
    IMPLICIT NONE
    !
  ...
  SUBROUTINE qes_init_electron_control(obj, tagname, diagonalization, mixing_mode, mixing_beta,&
                                      conv_thr, mixing_ndim, max_nstep, real_space_q, tq_smoothing,&
                                      tbeta_smoothing, diago_thr_init, diago_full_acc, diago_cg_maxiter,&
                                      diago_david_ndim)
    !
    IMPLICIT NONE
    !
  ...
  SUBROUTINE qes_init_total_energy(obj, tagname, etot, eband, ehart, vtxc, etxc, ewald, demet,&
                                  efieldcorr, potentiostat_contr, gatefield_contr)
    !
    IMPLICIT NONE
    !
